...
public class AjoutArticleController {
    ...
    @FXML
    private TextField volumeTextField; // Champ de texte pour le volume
            ...
            try {
                ...
                if (connection != null) {
                    try {
                        ...
                        String sql = "INSERT INTO Article (libelle, categorie, taille, couleur, volume, poids, quantite) VALUES (?, ?, ?, ?, ?, ?, ?)";
                        ...
                        preparedStatement.setInt(7, quantiteInt); // Utilisez la version int
